...
def pack_pathway_output(cfg, frames, frames2):
    """
    ...
    if cfg.DATA.REVERSE_INPUT_CHANNEL:
        frames = frames[[2, 1, 0], :, :, :]
        frames2 = frames2[[2, 1, 0], :, :, :]
    if cfg.MODEL.ARCH in cfg.MODEL.SINGLE_PATHWAY_ARCH:
        # print('1111111111111111111111')
        frame_list = [frames, frames2]

    elif cfg.MODEL.ARCH in cfg.MODEL.MULTI_PATHWAY_ARCH:
        # print('222222222222222222222')
        fast_pathway = frames
        fast_pathway2 = frames2
        ...
        slow_pathway2 = torch.index_select(
            frames2,
            1,
            torch.linspace(
                0, frames2.shape[1] - 1, frames2.shape[1] // cfg.SLOWFAST.ALPHA
            ).long(),
        )
        frames_list1 = [slow_pathway, fast_pathway]
        frames_list2 = [slow_pathway2, fast_pathway2]
        frame_list = [frames_list1, frames_list2]
    else:
...
def val_pack_pathway_output(cfg, frames):
    """
    Prepare output as a list of tensors. Each tensor corresponding to a
    unique pathway.
    Args:
